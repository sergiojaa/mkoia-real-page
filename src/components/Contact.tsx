export default function Contact() {
  ...
  return (
    <div>
      <div className='md:mt-[150px] md:ml-[130px] mt-[200px] ml-[20px]  font-lato xl:ml-[250px] lg:flex' >
        ...
        <div>
          ...
          <iframe className='md:w-[500px] xl:ml-[230px] lg:mr-[20px]  mt-[20px] mb-[30px] w-[95%] ' src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d312.38115815077873!2d44.77721875147236!3d41.737564100996416!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x404472eb6dc34267%3A0x2d1d3a51dfe5376b!2zNTkgUmFmYWVsIEFnbGFkemUgU3QsIOGDl-GDkeGDmOGDmuGDmOGDoeGDmCAwMTE5!5e1!3m2!1ska!2sge!4v1730995795334!5m2!1ska!2sge" width="600" height="450" loading="lazy" referrerPolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
