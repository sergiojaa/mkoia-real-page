  ...
  return (
    <div className='flex items-center justify-center'>
      <div className='md:flex  xl:mt-[-100px]' >
        <div className='xl:ml-[100px] ml-[20px]  mt-[150px] xl:mt-[250px] ' >
        ...
        <div>
          <img className='xl:w-[550px] mr-20  p-[20px] h-[450px] md:mt-[200px]  xl:ml-[50px] xl:mt-[300px] ' src={image2} alt="photo about logistic" />
